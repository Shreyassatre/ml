...
function Login() {
    ...
    <div className="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto bg-light">
        <div className="mt-5 px-lg-5 px-md-5 card card0 border-0">
            <div className="row d-flex">
                <div className="col-lg-6">
                    <div className="card1 pb-5">
                        <div className="row px-3 justify-content-center mt-5 mb-5 border-line"> <img src="images/login-img.png" className="image"/> </div>
                    </div>
                </div>
                <form className="col-lg-6" onSubmit={login}>
                    <div className="card2 card border-0 px-4 py-5">
                        ...
                        <center><div className="mb-3 px-3"> <button type="submit/reset" style={{background:"#333334", color:"white", border:"1px solid"}} className="btn text-center w-50">Log In</button></div></center>
                    </div>
                </form>
            </div>
        </div>
...
export function LoginBtn() {
  return (
    <div>
        <a className="log_in_btn" href='/login'>
            Log In
        </a>
    </div>
  )
